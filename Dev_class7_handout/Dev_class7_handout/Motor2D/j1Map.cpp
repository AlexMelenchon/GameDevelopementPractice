...
TileSet* j1Map::GetTilesetFromTileId(int id) const
{
	...
	uint i = 0;
	for (p2List_item<TileSet*>* tileSearch = data.tilesets.start; tileSearch != NULL; tileSearch = tileSearch->next)
	{

		if (id >= tileSearch->data->firstgid && (tileSearch->next == NULL || id <= tileSearch->next->data->firstgid ))
